...
public class XmlInputFormatTest {
    ...
    private final File minimizedInputFile = new File( "src/test/resources/test_files/test_data_full_minimized.xml" );
    private final File minimizedOutputFile = new File( "src/test/resources/test_files/test_data_article_minimized.xml" );
    ...
    @Test
    public void testFormattedFile() throws IOException, InterruptedException {

        testFile( inputFile );
    }

    @Test
    public void testMinimizedFile() throws IOException, InterruptedException {

        testFile( minimizedInputFile );
    }

    private void testFile( File file ) throws IOException, InterruptedException {
