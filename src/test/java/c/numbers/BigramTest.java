...
import c.numbers.a.bigram.BigramMapper;
import c.numbers.a.bigram.BigramReducer;
...
public class BigramTest {
    ...
    public void setup() {
        ...
        BigramMapper mapper = new BigramMapper();
        BigramReducer reducer = new BigramReducer();
    ...
    public void testMapper() throws IOException {
        ...
        mapDriver.withInput( new LongWritable(), new Text( input ) )
                .withOutput( new Text( ( WORD_1 + " " + WORD_2 ).toLowerCase() ), new IntWritable( 1 ) )
                .withOutput( new Text( ( WORD_2 + " " + WORD_3 ).toLowerCase() ), new IntWritable( 1 ) )
                .withOutput( new Text( ( WORD_3 + " " + WORD_4 ).toLowerCase() ), new IntWritable( 1 ) )
                .runTest();
    }
    ...
    public void testReducer() throws IOException {
        ...
        String input1 = WORD_1 + " " + WORD_2, input2 = WORD_2 + " " + WORD_3;
